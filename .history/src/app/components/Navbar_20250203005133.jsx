            ...
            <div className="mobile menu block md:hidden">
                {
                    !navbarOpen ? (
                        ...
                        <button onClick={() => setNavbarOpen(false)} className="flex items-center px-4 py-2 sm: px-2 py-0 border rounded border-slate-800 text-slate-800 hover:text-black hover:border-black">
                            <CgClose/>
                        </button>
                    )
                }
