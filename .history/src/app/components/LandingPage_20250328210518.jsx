    ...
    <div className="relative">
      {!isIntroComplete && (
        ...
        >
          ...
          <div className="mt-10 h-10 mb-10">
            {hoverWord && (
              <motion.p
          ...
          <motion.div
            className="absolute bottom-4 flex flex-col items-center text-primary"
            initial={{ opacity: 1 }}
            animate={{ opacity: isIntroComplete ? 0 : 1 }}
            transition={{ duration: 0.5 }}
          >
            <p className="text-xl mb-8"><PiShootingStarFill className ="text-accent"/> All together</p>
