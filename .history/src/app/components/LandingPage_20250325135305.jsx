        ...
        >
          ...
          >
            ...
            <motion.span
              ...
              animate={{
                rotate: [-10, 10, -10], // Swings left and right
                y: [0, 5, 0], // Slight up-down motion
              }}
              transition={{
                repeat: Infinity,
                duration: 1.5,
            ...
            Glo
            <motion.span className={styles.gradient}>i</motion.span>
            <motion.span className={styles.gradient}>a</motion.span>
          </motion.h1>
