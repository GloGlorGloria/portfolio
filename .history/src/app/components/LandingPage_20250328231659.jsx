      ...
      {!isLandingComplete && (
        ...
        >
          ...
          <motion.p
              ...
              onMouseEnter={() => setHoverWord("typing")}
              onMouseLeave={() => setHoverWord("")}
            >
              <PiShootingStarFill /> All together
            </motion.p>
            {hoverWord === "typing" && (
  <TypeAnimation
    key={hoverWord}
    sequence={[
      ...
      1000,
      "Resilience + Innovation + Adaptability = infinite possibility"
    ]}
    wrapper="span"
    speed={50}
    style={{ fontSize: '1.25rem', color: 'var(--text)', marginTop: '1rem' }}
    repeat={0}
  />
)}
