        ...
        >
          ...
          <motion.h1
            ...
            animate={{
              y: 0,
              opacity: 1,
              rotate: [0, -10, 10, -10, 5, -5, 0], // Swings three times and stops
            }}
            transition={{
              duration: 2,
              ease: "easeOut",
          ...
          >
            ...
            <motion.span
              ...
              animate={{
                rotate: [-10, 10, -10], // Keeps swinging after main animation stops
                y: [0, 5, 0],
              }}
              transition={{
                repeat: Infinity,
                duration: 1.5,
                ease: "easeInOut",
                delay: 2, // Starts after the whole word stops swinging
              }}
            >
              r
            </motion.span>
            ...
            <motion.span
              ...
              animate={{
                rotate: [-5, 5, -5], // Keeps swinging slightly
              }}
              transition={{
                repeat: Infinity,
                duration: 1.5,
