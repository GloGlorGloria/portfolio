    ...
    <section> 
        <div className="grid grid-cols-1 lg:grid-cols-12">
            <div className="col-span-7 place-self-center">
                ...
                <div>
                    <button className={`${styles.button} ${styles.left}`}>See my work <GoArrowUpRight className={`${styles.goArrow}`}/></button>
                    <button className={`${styles.button} ${styles.right}`}>More about me <FaAddressCard/></button>
                </div>
            </div>
