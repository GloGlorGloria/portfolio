    ...
    <Link href={projUrl}>
      <div className="w-full max-w-xl mx-auto space-y-4">
        <div className="relative w-full h-72 md:h-[28rem] lg:h-[45rem]rounded-xl overflow-hidden group">
          ...
          />
          <div className="absolute inset-0 flex flex-row gap-6 items-center justify-center px-6 py-4 rounded-xl bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
              <div className="flex flex-col">
                <h1 className="text-white text-3xl font-bold">{title}</h1>
                <p className="text-white text-base font-semi-bold opacity-80">{description}</p>
              </div>
