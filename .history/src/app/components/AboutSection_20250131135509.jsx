...
const TAB_DATA = [
    ...
    },
    {
        ...
        content: (
            <ul>
                <li> Digital Design and Development Diploma, British Columbia Institute of Technology</li>
                <li> Bachelor of Arts (Honours) in Social Policy & Administration, The Hong Kong Polytechnic University </li>
            </ul>
        )
    },
    {
        ...
        content: (
            <ul>
                <li> Information Officer (Media Liaison), The Fire Services Department, Hong Kong Government </li>
                <li> Assistant Information Officer, The Information Services Department, Hong Kong Government </li>
                <li> Research Assistant, The Hong Kong Polytechnic University </li>
            </ul>
        )
    }
]
