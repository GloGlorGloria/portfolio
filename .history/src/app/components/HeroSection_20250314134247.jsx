...
const HeroSection = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (showLanding && window.scrollY > window.innerHeight * 0.3) {
        setShowLanding(false); // Fade out landing page permanently
      }
    };
  ...
  return (
    <section>
      {/* 🚀 Fullscreen Landing Page (Only Shows Once Per Visit) */}
      {showLanding && (
        <motion.div
