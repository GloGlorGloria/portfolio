    ...
    <div className="relative">
      {!isIntroComplete && (
        ...
        >
          ...
          >
            <p className="text-xl mb-8">✨All together</p>
            <FaAnglesDown className="text-[var(--accent)] w-6 h-auto mx-auto flex justify-center items-center mb-32 animate-bounce" />
          </motion.div>
        </motion.div>
      )}
