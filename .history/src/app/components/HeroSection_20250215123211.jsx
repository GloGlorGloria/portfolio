...
const HeroSection = () => {
    return (
    <section> 
        <div className="grid place-items-center grid-cols-1 min-h-screen py-28 sm:grid-cols-12 sm:py-4 mb-16 sm:mb-4">
                ...
                <div className={styles.buttons}>
                    ...
                    <Link href="/about" passHref>
                        <button className={styles.button__right}>
                            <span className="block bg-[#fff0df] rounded-full px-5 py-2" >More about me <FaAddressCard/></span>
                        </button>
                    </Link>
                </div>
            </div>
