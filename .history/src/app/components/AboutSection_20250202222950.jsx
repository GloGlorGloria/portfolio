        ...
        <section>
            ...
            <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 xl: gap-16 sm:py-16">
                <div>
                    ...
                    <p className="flex justify-end items-center"> <PiCursorClickFill className="mr-4 text-gray-500 hover:text-red-500 transition duration-300" />  Click to learn more about me!</p>
                </div>
