...
const ProjectsSection = () => {
  return (
    <section className="max-w-6xl mx-auto px-4">
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-4 auto-rows-auto">
        {projectsData.map((project, index) => (
          <div
            key={project.id}
            className={`relative group overflow-hidden ${
              index % 3 === 0
                ? "col-span-2 row-span-2 aspect-[4/3]" // Wider images
                : "col-span-1 row-span-1 aspect-[3/4]" // Smaller images
            }`}
          >
