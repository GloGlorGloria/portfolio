    ...
    return (
        <section>
            ...
            <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl: gap-16 sm:py-16">
                <div>
                    <Link href="/about">
                        <Image src={"/images/aboutme.gif"} alt="A winking gif with smile ." width={500} height={500}   className="flex justify-start cursor-pointer" />
                    </Link>
                    <p className="flex justify-end items-center"><PiCursorClickFill className="mr-4" /> Click to learn more about me!</p>
                </div>
