...
const HeroSection = () => {
  ...
  return (
    <section>
      ...
      <motion.div
        className={`h-screen w-full flex flex-col items-center justify-center text-center bg-[#fdf6ec] fixed top-0 left-0 right-0 z-50 ${
          showLanding ? "visible" : "invisible"
        }`}
        initial={{ opacity: 1 }}
      ...
      {/* 🚀 Hero Section (Positioned Below the Landing Page) */}
      <div className="h-screen" /> {/* Empty spacer to push Hero Section down */}
