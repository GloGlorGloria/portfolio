...
const HeroSection = () => {
  ...
  return (
    <section>
      ...
      <motion.div
        className="h-screen flex flex-col items-center justify-center text-center bg-[#fdf6ec] w-full absolute top-0 left-0 right-0 z-10"
        initial={{ opacity: 1 }}
        animate={{ opacity: isIntroComplete ? 0 : 1, y: isIntroComplete ? -50 : 0 }}
        transition={{ duration: 0.8 }}
        style={{ pointerEvents: isIntroComplete ? "none" : "auto" }} // Ensures clicks pass through when faded
      >
        <motion.h1
