      ...
      <div className={styles.contentContainer}>
        ...
        <section className={styles.sectionContainer}>
            ...
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
                <Image
                  src="/imagesProjects/Ford/Ford_iPad.jpg"
        ...
        <div className={styles.additionalImages}>
            ...
            <div className={styles.additionalImagesGrid}>
                <Image
                  src="/images/Projects/Fordward_vertical.png"
                  alt="Ford poster"
                  width={800}
                  height={400}
                  className={styles.projectImage_Special}
            ...
            <div className={styles.additionalImagesGridRight}>
                <Image
                    src="/images/Projects/fordward outdoor.png"
                ...
                />
                <Image
                    src="/images/Projects/Fordward_board.jpg"
                    alt="Ford poster outdoor"
                    width={800}
                    height={400}
                    className={styles.projectImage}
