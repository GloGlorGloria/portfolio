      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.projectDetails}>
          ...
          <div className={styles.rightColumn}>
            ...
            This is a magazine design project focused on sustainable green building, featuring rich content and engaging visuals to showcase eco-friendly architecture, practices, and global examples. The deliverables include a printed magazine and an interactive digital version optimized for online publication.
            </p>
