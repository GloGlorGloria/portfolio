          ...
          <div className={styles.projectDetails}>
            ...
            <div className={styles.rightColumn}>
              <div className={styles.sections}>
                ...
                This is a magazine design about sustainable green architecture, featuring engaging content and visuals. The deliverables include a printed magazine and an interactive digital version for online publication.
                </p>
              </div>
              <div className={styles.sections}>
