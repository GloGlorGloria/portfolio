        ...
        <div className="mb-12 flex gap-4">
          {["All", "UX/UI Design", "Graphic Design"].map((category) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-lg font-semi-bold transition-colors duration-300 ${
                selectedCategory === category
                  ? "bg-[var(--primary)] text-[var(--accent)]"
                  : "bg-[var(--secondary)] text-[var(--primary)] hover:bg-[var(--accent)] hover:text-white"
              }`}
            >
              {category}
            </button>
