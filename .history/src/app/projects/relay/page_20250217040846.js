          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div className="mb-4">
                  <p className={styles.projectSummary}>
                  Bringing Relay to life goes beyond building the app—the team also created key promotional materials, including a <span></span>
                  <Link
                    href="https://relay.arspera.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >landing page</Link>, brochures, name cards, stickers, and Instagram (
                    ...
                    rel="noopener noreferrer"
                    className={`${styles.projectName} ${styles.link}`}
                  >@relay.rideshare</Link>) to strengthen marketing and branding. By maintaining consistent colors and typography, these materials ensure a cohesive identity. <span></span>
                  <Link
