          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>1. Smart Route Matching</h2>
                <div className="mb-4">
                  ...
                  <br></br>
                  <p className={styles.projectSummary}> It also estimates ride time changes based on different matches. This feature enables parents whose kids are attending the same activities to group together, making carpooling more efficient and contributing to a greener future.</p>
                </div>        
            </div>
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
