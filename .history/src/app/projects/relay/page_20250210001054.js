            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div className="mb-4">
                  ...
                  <br></br>
                  <p className={styles.projectSummary}>The user story map helped break down user needs, identify dependencies, and define the Minimum Viable Product (MVP). These tools played a key role in ensuring a seamless user experience, improving team alignment, and optimizing development efficiency.</p>
                </div>
              </div>
              </div>
            </div>
