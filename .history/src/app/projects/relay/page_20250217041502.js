              ...
              <div className={styles.sections}>
                ...
                <div className="mb-4">
                  ...
                  >landing page</Link>, brochures, name cards, stickers, and Instagram (
                    ...
                    rel="noopener noreferrer"
                    className={`${styles.projectName} ${styles.link}`}
                  >@relay.rideshare</Link>) to strengthen marketing and branding. By maintaining consistent colors and typography, these materials ensure a cohesive identity.</p>
                  <p className={styles.projectSummary}>
