          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <div className={styles.sections}>
                ...
                <div className="mb-4">
                  ...
                  <br></br>
                  <p className={styles.projectSummary}>The branding colors, a mix of <span className="font-bold text-accent">orange</span> and <span className="font-bold text-primary">red</span>, reinforce warmth and trust, supporting a safe, community-driven environment. The logo integrates key elements of radar, a car side mirror, and eco-friendly symbolism to represent connectivity and sustainability within the Relay brand.</p>
                </div>
              </div>
            </div>
            {/* Left Column: Large Image */}
