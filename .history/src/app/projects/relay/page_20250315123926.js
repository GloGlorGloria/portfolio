          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div>
                  <p className={styles.projectSummary}>
                    These insights shaped a solution prioritizing <span className="font-bold text-primary">safety, convenience,</span> and <span className="font-bold">trusted connections</span>. Learn more from the <span></span>
                    <Link
