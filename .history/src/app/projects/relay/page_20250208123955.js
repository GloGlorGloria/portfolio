          ...
          <div className={styles.projectDetails}>
            ...
            <div className={styles.rightColumn}>
              <div className={styles.sections}>
                ...
                Relay is <span className={styles.projectName}> Canada’s first ridesharing app for parents</span>, designed to provide safe and reliable carpooling within trusted networks. Through in-depth interviews and surveys, the team identified key challenges and developed an <span className={styles.projectName}>AI-powered solution</span> that eases transportation burdens while fostering social connections. Recognized by angel investors for its innovation and market potential, Relay won 1st place at the Annual Student Innovation Design & Technology Showcase.
                </p>
              </div>
              <div className={styles.sections}>
