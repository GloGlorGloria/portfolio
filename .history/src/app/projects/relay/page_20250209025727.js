    ...
    <main className={styles.mainContainer}>
      <div className={styles.contentContainer}>
        <div className={styles.projectTitle}>
          <h1 className={styles.project__primaryTitle} >Award-winning Mobile App Developemnt — Case Study<RiParentFill className={styles.bookOpen}/></h1>
          <Image
