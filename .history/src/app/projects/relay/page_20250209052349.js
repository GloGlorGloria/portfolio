        ...
        <section className={styles.sectionContainer}>
            ...
            <h1 className={styles.sectionTitle}>User Personas <DiProlog className={styles.designIcon}/></h1>
                <div className="mb-4">
                  ...
                  <br></br>
                  <ul>
                    <li className={styles.numberList}>Meet Joseph, a full-time software engineer and father of a 10-year-old son, struggles to arrange reliable rides due to his demanding schedule. He values a tech-driven ridesharing solution with GPS tracking and reliable connections. </li>
