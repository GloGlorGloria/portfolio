          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>2. Safety at the heart of Relay <FaSafari className={styles.designIcon__small}/></h2>
                <div className="mb-4">
                  ...
                  <br></br>
                  <ul>
                    <li className={styles.numberList}><span className="font-bold orange">Real-Time GPS Tracking </span>— Parents can track their child’s ride from start to finish, ensuring peace of mind.</li>
