        ...
        <section className={styles.sectionContainer}>
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <div className={styles.sections}>
                ...
                <div className="mb-4">
                  <p className={styles.projectSummary}>
                    Originally, the team envisioned a broad ridesharing solution focused on eco-friendliness and resource sharing. However, after in-depth research and considering a tight timeline, the focus shifted to the specific challenges faced by working parents. It also became clear that parents were hesitant to use ridesharing for their children without robust safety measures, so the concept was refined to emphasize safety and trust. </p>
                  <br></br>
                  <p className={styles.projectSummary}>
                    Building Relay presented significant challenges. The app required dynamic accounts for both parents and drivers, a user-friendly yet advanced interface, and features such as smart route matching, AI ride notifications, and GPS live tracking. Overcoming these obstacles not only took extra time but also confirmed Relay's potential to make a real difference. The team is confident that this approach will bridge technology with everyday needs, bringing parents and children closer together. Special thanks go to everyone for their hard work and dedication in bringing Relay to life!</p>
                    <br></br>
