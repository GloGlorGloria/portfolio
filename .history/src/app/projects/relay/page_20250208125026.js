          ...
          <div className={styles.projectDetails}>
            ...
            <div className={styles.rightColumn}>
              <div className={styles.sections}>
                ...
                Relay is <span className={styles.projectName}> Canada’s first ridesharing app for parents</span>, offering safe and reliable rides within trusted networks. Through in-depth research, the team identified key challenges and developed an <span className={styles.projectName}>AI-powered solution</span> to ease transportation burdens and foster social connections. Recognized for its innovation and market potential, Relay won 1st place at the Annual Student Innovation Design & Technology Showcase.
                </p>
              </div>
              <div className={styles.sections}>
