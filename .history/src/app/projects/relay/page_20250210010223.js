          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>1. Smart Route Matching</h2>
                <div className="mb-4">
                  ...
                  <br></br>
                  <p className={styles.projectSummary}> The app also estimates ride time changes based on different matches, allowing parents to quickly form carpools with others heading to the same destination with their preferences. This not only saves time but also makes ridesharing more efficient and convenient.</p>
                </div>        
            </div>
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
         ...
         <section className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>2. Safety Features</h2>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
                  The smart route matching feature streamlines planning for both parents and drivers, easing the transportation load. Previously, parents had to check individually with family or friends to see if their schedules and routes aligned. With Relay, the app automatically suggests ride matches based on similar routes and times, making the process quick and effortless with just a few taps.
                  </p>
                  <br></br>
