          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>3. Connect with trusted community</h2>
                <div className="mb-4">
                  ...
                  <br></br>
                  <p className={styles.projectSummary}>To ensure security, identity verification is required to join school groups, confirming all members have children at the same school. Parents can also create private groups with their trusted network, using in-app messaging and coordination tools for seamless carpool planning. Beyond convenience, ridesharing strengthens connections, helping both parents and kids build closer relationships within their community.
                  </p>
                </div>        
            </div>
            {/* Left Column: Large Image */}
