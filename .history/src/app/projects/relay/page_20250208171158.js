        ...
        <section className={styles.sectionContainer}>
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <h3>Pain Points</h3>
                <p>With 75% of Canadian families with children aged 6–12 having two working parents, many struggle to balance work with their kids’ transportation needs due to limited reliable options.</p>
              </div>
              <div>
                <h3>Solution</h3>
