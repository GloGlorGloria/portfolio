            ...
            <div className={styles.rightColumn}>
              ...
              <div className="flex flex-row gap-5">
                <div className={styles.viewOnline}>
                  ...
                  >
                  <span 
                    className="bg-[#fff0df] hover:text-orange-500 rounded-full px-2.5 py-1.5" 
                ...
                <div className={styles.viewOnline}>
                  ...
                  >
                  <span 
                    className="bg-[#fff0df] hover:text-orange-500 rounded-full px-5 py-1.5" 
                  > Wireframes <Image src="/icons/Illustrator.svg" alt="Adobe Illustrator Icon" width={40} height={40} />< IoLogoFigma className={styles.goArrow}/> </span>
                  </Link>
                </div>
              </div>
