    ...
    <main className={styles.mainContainer}>
      <div className={styles.contentContainer}>
       ...
       {/* Overview */}
        ...
        {/* User Research */}
        <section className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__sectioin}`}>
            <div className={styles.leftColumn}>
            <Image
        ...
        <section className={styles.sectionContainer}>
            ...
            <h1 className={styles.sectionTitle}>User Personas <DiProlog className={styles.designIcon}/></h1>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
                  To make sure RELAY truly works for parents, user personas were created based on real stories from surveys and interviews. Meet Joseph, a full-time software engineer juggling work and family life, constantly scrambling to find reliable rides for his 10-year-old. He wants a smart, safe carpooling solution with GPS tracking and trusted connections. Then there’s Sarah, a part-time climate policy advisor who loves helping her community by giving kids rides but struggles to coordinate with busy parents. These personas shaped RELAY’s design, making it a go-to app for safe, convenient, and community-driven carpooling.
                  </p>
                </div>
                <div>
                  <p className={styles.projectSummary}>
