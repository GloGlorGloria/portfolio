          ...
          <div>
            ...
            <div className={styles.overviewDetails}>
              <div>
                ...
                <p className={styles.projectDetails}>With 75% of Canadian families with children aged 6–12 having two working parents, the same percentage struggle to balance work and their kids’ transportation needs due to limited reliable options.</p>
              </div>
              <div>
