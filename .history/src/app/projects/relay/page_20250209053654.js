          ...
          <div>
            ...
            <div className={styles.overviewDetails}>
              ...
              <div>
                ...
                <p className={styles.projectSummary}>Relay is an AI-powered ridesharing platform that connects parents within trusted communities, simplifying transportation with smart route matching, GPS tracking, and real-time updates.</p>
              </div>
            </div>
          </div>
        </section>
