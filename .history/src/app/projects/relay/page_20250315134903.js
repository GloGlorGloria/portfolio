    ...
    <main className={styles.mainContainer}>
      ...
      <div className={styles.contentContainer}>
       ...
       {/* Overview */}
        ...
        {/* User Research */}
        <section id="user-research" className={styles.sectionContainer}>
        ...
        <section id="competitive-analysis" className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
        ...
        {/* User Persona */}
        <section id="user-personas" className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
              <div className={styles.sections}>
          ...
          {/* User workflow */}
          <section id="user-workflow" className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
              <div className={styles.sections}>
          ...
          {/* Style Guide */}
          <section id= "style-guide" className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
              <Image
         ...
         {/* Key Features 1 */}
         <section id= "key-features" className={styles.sectionContainer}>
        ...
        {/* Marketing & Branding */}
        <section id= "marketing-branding" className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
        ...
        {/* Project Pitching */}
        <section id= "conclusion"className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
              <Image
