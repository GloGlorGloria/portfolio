        ...
        <section className={styles.sectionContainer}>
            ...
            <h1 className={styles.sectionTitle}>User Personas <DiProlog className={styles.designIcon}/></h1>
                <div className="mb-4">
                  ...
                  <br></br>
                  <ul>
                    <li className={styles.numberList}>Meet Joseph, a full-time software engineer juggling work and family life, constantly scrambling to find reliable rides for his 10-year-old son. He wants a smart, safe ridesharing solution with GPS tracking and trusted connections. Then there’s Sarah, a part-time climate policy advisor who loves helping her community by giving kids rides but struggles to coordinate with busy parents. These personas shaped RELAY’s design, making it a go-to app for safe, convenient, and community-driven carpooling.</li>
                  </ul>
                </div>
                <div>
                  <p className={styles.projectSummary}>
