        ...
        <section className={styles.sectionContainer}>
            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div>
                  <ul>
                    <li className={styles.numberList}>Scheduling conflicts — 75% of parents struggle to arrange transportation due to conflicting schedules, and 67% report that transportation issues have disrupted their children’s participation in activities.</li>
                  </ul>
                </div>
                <div>
                  <p className={styles.projectSummary}>
