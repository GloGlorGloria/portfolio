        ...
        <section className={styles.sectionContainer}>
            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div>
                  <p className={styles.projectSummary}>
                    These insights shaped a solution prioritizing <span className="font-bold">safety, convenience,</span> and <span className="font-bold">trusted connections</span>. For more details, refer to the User Findings Report [insert link].
                  </p>
                </div>
              </div>
              </div>
