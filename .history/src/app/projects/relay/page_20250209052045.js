        ...
        <section className={styles.sectionContainer}>
            ...
            <h1 className={styles.sectionTitle}>User Personas <DiProlog className={styles.designIcon}/></h1>
                <div className="mb-4">
                  ...
                  <br></br>
                  <ul>
                    <li className={styles.numberList}>Meet Joseph, a full-time software engineer juggling work and family life, constantly scrambling to find reliable rides for his 10-year-old son. He wants a smart, safe ridesharing solution with GPS tracking and trusted connections. </li>
                    <li className={styles.numberList}>Meet Sarah, a stay-at-home mom with three kids, who needs a convenient, reliable way to organize carpools for her children’s extracurricular activities. She values privacy and trusted connections.</li>
                  </ul>
                </div>
                <div>
                  <p className={styles.projectSummary}>
