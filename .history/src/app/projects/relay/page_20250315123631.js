          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <div className={styles.sections}>
                ...
                <div className="mb-4">
                  ...
                  <br></br>
                  <p className={styles.projectSummary}>
                    Building Relay presented significant challenges. The app <span className="font-bold text-primary">required dynamic accounts for both parents and drivers</span>, a <span className="font-bold text-secondary">user-friendly yet advanced interface</span>, and features such as smart route matching, AI ride notifications, and GPS live tracking. Overcoming these obstacles not only took extra time but also confirmed Relay's potential to make a real difference. Special thanks to everyone for their hard work and dedication in bringing Relay to life!</p>
                    <br></br>
