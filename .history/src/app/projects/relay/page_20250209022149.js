              ...
              <div className={styles.sections}>
                ...
                <div>
                  <ul>
                    ...
                    <li className={styles.numberList}><span className="font-bold">Rideshare demand</span>—82% currently rely on family or friends for help, yet all parents express interest in carpooling with trusted parents from their children’s school or activity groups.</li>
                  </ul>
                </div>
                <div>
                  <p className={styles.projectSummary}>
