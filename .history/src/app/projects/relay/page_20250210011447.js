            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div className="mb-4">
                  ...
                  <ul>
                    <li className={styles.numberList}><span className="font-bold">Real-Time GPS Tracking</span>– Parents can monitor their child’s ride from start to finish, ensuring peace of mind. </li>
