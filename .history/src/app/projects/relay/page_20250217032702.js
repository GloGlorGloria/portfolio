       ...
       {/* Overview */}
        ...
        <section className={styles.sectionContainer}>
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            {selectedImage && <ImageModal src={selectedImage} alt="Relay Wordflow" onClose={() => setSelectedImage(null)} />}
        </section>
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            {selectedImage && <ImageModal src={selectedImage} alt="Relay Style Guide" onClose={() => setSelectedImage(null)} />}
        </section>
