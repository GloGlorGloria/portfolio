      ...
      <div className={styles.contentContainer}>
       ...
       {/* Overview */}
        ...
        <section className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
            <h1 className={styles.sectionTitle}>User Personas <DiProlog className={styles.designIcon}/></h1>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
              <div className={styles.sections}>
                <h1 className={styles.sectionTitle}>User Workflow <DiProlog className={styles.designIcon}/></h1>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>2. Safety Features</h2>
                <div className="mb-4">
                  ...
                  <br></br>
                  <ul>
                    <li className={styles.numberList}><span className="font-bold">Real-Time GPS Tracking </span>— Parents can track their child’s ride from start to finish, ensuring peace of mind.</li>
                    <li className={styles.numberList}><span className="font-bold">AI-Powered Ride Notifications </span>— Timely updates on ride progress and arrival times keep parents informed, making them feel as if they’re riding along.</li>
                    <li className={styles.numberList}><span className="font-bold">Unique Ride PIN </span>—A secure, trip-specific PIN ensures kids enter the correct car, adding an extra layer of protection.</li>
                    <li className={styles.numberList}><span className="font-bold">Community Trust Building </span>— Parents can connect with fellow drivers and leave reviews, building a trustworthy and reliable ridesharing network.</li>
                  </ul>
                  <p className={styles.projectSummary}> It also estimates ride time changes based on different matches. This feature enables parents whose kids are attending the same activities to group together, making ridesharing more efficient and contributing to a greener future.</p>
                </div>        
            </div>
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
