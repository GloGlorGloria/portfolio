        ...
        <section className={styles.sectionContainer}>
            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div>
                  <p className={styles.projectSummary}>
                    These insights shaped a solution prioritizing <span className="font-bold">safety, convenience,</span> and <span className="font-bold">trusted connections</span>. Learn more from the   
                    <Link
                    href="https://www.linkedin.com/feed/update/urn:li:activity:7272008089032101888/"
                    target="_blank"
                    rel="noopener noreferrer"
