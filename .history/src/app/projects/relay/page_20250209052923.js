        ...
        <section className={styles.sectionContainer}>
            ...
            <h1 className={styles.sectionTitle}>User Personas <DiProlog className={styles.designIcon}/></h1>
                <div className="mb-4">
                  ...
                  <br></br>
                  <ul>
                    <li className={styles.numberList}>Meet Joseph, a full-time software engineer and father of a 10-year-old son, struggles to arrange reliable rides due to his demanding schedule. He values a tech-driven ridesharing solution with GPS tracking and reliable network. </li>
                    <li className={styles.numberList}>Meet Sarah,  a part-time climate policy advisor, enjoys helping her community by giving kids rides but finds it hard to coordinate with busy parents. She seeks a platform that simplifies scheduling, enhances communication, and builds connection. </li>
                  </ul>
                  <p className={styles.projectSummary}>These personas guide app development by representing real users' needs, behaviors, and challenges, ensuring the design and features effectively meet user expectations.</p>
                </div>        
            </div>
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
