          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h1 className={styles.sectionTitle}>Competitive Analysis <PiFileMagnifyingGlassFill className={styles.designIcon}/></h1>
                <div className="mb-4">
                  ...
                  <br></br>
                  <p className={styles.projectSummary}>
                    The analysis highlights Relay’s unique position as an all-in-one platform that combines ride scheduling, in-app communication, real-time GPS tracking, and AI-powered ride notifications. Its focus on <span className="font-bold text-secondary">community-driven connections</span> through public and private group channels further sets it apart. By assessing competitor 
                    <Link
