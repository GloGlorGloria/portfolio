       ...
       {/* Overview */}
        ...
        <section className={styles.sectionContainer}>
          <div>
            ...
            <p className={styles.quotes}> <span className={styles.quotation}>"</span>Great design starts with listening—deeper insights drive impactful solutions that truly help." </p>
          </div>
        </section>
