       ...
       {/* Overview */}
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h1 className={styles.sectionTitle}>Competitive Analysis <PiFileMagnifyingGlassFill className={styles.designIcon}/></h1>
                <div className="mb-4">
                  ...
                  <p className={styles.projectSummary}>
                    ...
                    </Link>, the research also identified actionable improvements to enhance user experience, design, and features. 
                  </p>
                  <br></br>
                  <p className={styles.projectSummary}>For more details, check out the <span></span>
                  <Link
                      href="https://drive.google.com/file/d/1c4TINDPu6sJ7nhVOq573Z6je1yFC2zIl/view?usp=sharing"
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`${styles.projectName} ${styles.link}`}>
                    full report.
            ...
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
                ...
                >
                <Image
                   src="/images/projects/relay/competitors.png"
                   alt="Relay Competitive Analysis"
                   width={1200}
                   height={800}
                   className={styles.largeImage}
                   style={{ cursor: "pointer" }} /> 
        ...
        <section className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
              <div className={styles.sections}>
                  <ImageCarouselModal className={styles.largeImage} images={userPersona} /> 
              </div>
            </div>
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
         ...
         <section className={styles.sectionContainer}>
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
                <div className={styles.sections}>
                  <ImageCarouselModal className={styles.largeImage} images={smartRoute} /> 
                </div>
              </div>
            </div>
        </section>
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>2. Safety at the heart of Relay <FaSafari className={styles.designIcon__small}/></h2>
                <div className="mb-4">
                  ...
                  <br></br>
                  <ul>
                    <li className={styles.numberList}><span className="font-bold text-via-orange-500">Real-Time GPS Tracking </span>— Parents can track their child’s ride from start to finish, ensuring peace of mind.</li>
                    <li className={styles.numberList}><span className="font-bold text-primary">AI-Powered Ride Notifications </span>— Timely updates on ride progress and arrival times keep parents informed, making them feel as if they’re riding along.</li>
                    <li className={styles.numberList}><span className="font-bold text-primary">Unique Ride PIN </span>— A secure, trip-specific PIN ensures kids enter the correct car, adding an extra layer of protection.</li>
                  </ul>
