        ...
        <section className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
              <div className={styles.sections}>
                <h1 className={styles.sectionTitle}>Promotion & Branding <RiSurveyFill className={styles.designIcon}/></h1>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
                  Bringing Relay to life goes beyond building the app—the team also created key promotional materials, including a landing page, brochures, name cards, stickers, and Instagram (@relay.rideshare) to strengthen marketing and branding. By maintaining consistent colors and typography, these materials ensure a cohesive identity. Development blogs further document the journey, keeping users engaged with updates.
                  </p>
                  <br></br>
                  <p className={styles.projectSummary}>
