          ...
          <div>
            ...
            <div className={styles.overviewDetails}>
              <div>
                ...
                <p className="justify-content">With 75% of Canadian families with children aged 6–12 having two working parents, the same percentage struggle to balance work and their kids’ transportation needs due to limited reliable options.</p>
              </div>
              <div>
                <h3 className="mb-2">Solution</h3>
                <p>Relay provides an AI-powered ridesharing platform that connects parents within their <span className="font-bold">trusted community</span>, easing transportation burdens through smart route matching, live GPS tracking, and real-time ride updates.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={styles.sectionContainer}>
          <div>
            ...
            <div className={styles.overviewDetails}>
              <div>
                <h3 className="mb-2">Pain Points</h3>
                <p>With 75% of Canadian families with children aged 6–12 having two working parents, the same percentage struggle to balance work and their kids’ transportation needs due to limited reliable options.</p>
              </div>
              <div>
                <h3 className="mb-2">Solution</h3>
                <p>Relay provides an AI-powered ridesharing platform that connects parents within their <span className="font-bold">trusted community</span>, easing transportation burdens through smart route matching, live GPS tracking, and real-time ride updates.</p>
