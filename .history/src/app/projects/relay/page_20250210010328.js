          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>1. Smart Route Matching</h2>
                <div className="mb-4">
                  ...
                  <br></br>
                  <p className={styles.projectSummary}> The app also estimates ride time changes based on different matches, allowing parents to quickly form carpools with others heading to the same destination with their preferences. This not only saves time but also makes kids transportation more efficient, easing the load for parents.</p>
                </div>        
            </div>
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
