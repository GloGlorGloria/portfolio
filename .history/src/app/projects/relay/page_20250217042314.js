      ...
      <div className={styles.contentContainer}>
       ...
       {/* Overview */}
        ...
        <section className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            {/* Left Column: Large Image */}
              <div className={styles.rightColumn}>
              <div className={styles.sections}>
                <h1 className={styles.sectionTitle}>Marketing & Branding <RiSurveyFill className={styles.designIcon}/></h1>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
                  ...
                  <br></br>
                  <p className={styles.projectSummary}>
                    The Instagram account adopts an infographic style to visually explain the app’s concept and features in a clear, data-driven way, making it easy for parents to understand. This approach not only informs but also aims to resonate with our target audience, reinforcing Relay’s value in their daily lives. <span></span>
                  <Link
        ...
        <section className={styles.sectionContainer}>
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
            <h2 className={styles.sectionTitle}>Promotional Video<FaCirclePlay className={styles.designIcon__small}/></h2>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
                  The promotional video takes a storytelling approach, highlighting the real-life challenges parents face with transportation. It showcases how Relay simplifies carpooling and fosters a stronger community. Special thanks to the team for their hard work and to the amazing young actors for bringing the story to life!
                  </p>
                </div>        
            </div>
            {/* Left Column: Large Image */}
