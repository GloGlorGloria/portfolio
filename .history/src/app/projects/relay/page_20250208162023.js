    ...
    <main className={styles.mainContainer}>
      <div className={styles.contentContainer}>
        <div className={styles.projectTitle}>
          <h1 className={styles.project__primaryTitle} >Mobile App Developemnt<RiParentFill className={styles.bookOpen}/></h1>
          <h3 className={styles.project__secondaryTitle} >Case Study</h3>
          <Image
        ...
        <section className={styles.sectionContainer}>
          <div>
            <h1 className={styles.sectionTitle}>Problem Statement</h1>
          </div>
        </section>
