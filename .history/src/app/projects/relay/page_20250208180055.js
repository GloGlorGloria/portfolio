          ...
          <div>
            ...
            <div className={styles.overviewDetails}>
              ...
              <div>
                ...
                <p>Relay provides an AI-powered ridesharing platform that connects parents within their <span className="font-bold"trusted community, easing transportation burdens through smart route matching, live GPS tracking, and real-time ride updates.</p>
              </div>
            </div>
          </div>
        </section>
