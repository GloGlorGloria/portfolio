    ...
    <main className={styles.mainContainer}>
      <div className={styles.contentContainer}>
        <div className={styles.projectTitle}>
          <h1 className={styles.project__primaryTitle} >Graphic Design <FaBookOpen className={styles.bookOpen}/></h1>
          <h2 className={styles.project__subtitle}>F1 2024 Series</h2>
        </div>
