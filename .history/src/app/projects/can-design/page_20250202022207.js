              ...
              <div className={styles.sections}>
                ...
                <div className="mb-4">
                  <ul className="list-disc list-inside text-md">
                    <li className="text-yellow-700 font-semibold">Green Tea (Earth) Warm yellow with Bamboo, symbolizing harmony and balance.</li>
                    <li className="text-red-800 font-semibold">Black Tea (People) Deep burgundy with Orchid, representing clarity and refinement.</li>
                    <li className="text-blue-700 font-semibold">White Tea (Sky) Soft blue with Plum Blossom, signifying vitality and resilience.</li>
                  </ul>
                </div>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
