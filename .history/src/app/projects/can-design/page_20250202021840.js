              ...
              <div className={styles.sections}>
                ...
                <div className="mb-4">
                  <ul className="list-disc list-inside text-md">
                    <li className="text-green">Green Tea (Earth) – Warm yellow with Bamboo, symbolizing harmony and balance.</li>
                    <li className="text-blue">Black Tea (People) – Deep burgundy with Orchid, representing clarity and refinement.</li>
