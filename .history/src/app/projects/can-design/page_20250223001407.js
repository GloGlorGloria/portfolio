...
export default function f1Poster() {
  ...
  const dielines = {
    "Green-Tea": { src: "/images/projects/cans/Green-Tea.svg", className: styles.greenTea },
    "Dark-Tea": { src: "/images/projects/cans/Dark-Tea.svg", className: styles.darkTea },
    "White-Tea": { src: "/images/projects/cans/White-Tea.svg", className: styles.whiteTea },
  };
    ...
    <main className={styles.mainContainer}>
      <div className={styles.contentContainer}>
          ...
          <div className={styles.projectDetails}>
            ...
            <div className={styles.leftColumn}>
               <Image
                ...
                onClick={() => setSelectedImage("/images/projects/cans/3-cans-bg-yellow.png")}
        ...
        <section className={styles.sectionContainer}>
              ...
              <div className={styles.sections}>
                ...
                <div className="flex gap-4 mt-14" >
                    <Image
                        ...
                        onClick={() => setSelectedImage("/images/projects/cans/Black-bg-front-back.png")}
                        style={{ cursor: "pointer" }}
                    />
                     <Image
                        ...
                        height={400}
                        className={styles.thumbnailImage}
                        onClick={() => setSelectedImage("/images/projects/cans/Green-bg-front-back.png")}
                        style={{ cursor: "pointer" }}
                    />
                     <Image
                        ...
                        height={400}
                        className={styles.thumbnailImage}
                        onClick={() => setSelectedImage("/images/projects/cans/White-bg-front-back.png")}
                        style={{ cursor: "pointer" }}
                    />
                </div>
              </div>
            ...
            {selectedImage && <ImageModal src={selectedImage} alt="Can Design" onClose={() => setSelectedImage(null)} />}
        </section>

        {/* Additional Project Images */}
        <div className={styles.additionalImages}>
            <div className={styles.dielineContainer}>
                <h2 className="mt-5 mb-5">Dielines</h2>

                <div className="flex flex-row content-center gap-4">
                <div className={styles.buttonContainer}>
                  {Object.keys(dielines).map((key) => (
                    <button
                      key={key}
                      className={`${styles.buttonUnderline} ${
                        selectedDieline === key ? styles.active : ""
                      }`}
                      onClick={() => setSelectedDieline(key)}
                    >
                      {key.replace("-", " ")}
                  ...
                  <Image
                    src={dielines[selectedDieline]}
                    alt={`${selectedDieline} Can Dieline`}
                    width={800}
                    height={400}
