...
export default function f1Poster() {
  ...
  const [selectedImage, setSelectedImage] = useState(null);
    ...
    const dielines = [
      "/images/projects/cans/Green-Tea.svg",
      "/images/projects/cans/Dark-Tea.svg",
      "/images/projects/cans/White-Tea.svg",
    ];
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.additionalImages}>
            <div className={styles.dielineContainer}>
                ...
                <ImageCarousel className={styles.projectImage_Special} images={dielines} /> 
                    {/* <Image
