  ...
  return (
    <main className="flex min-h-screen flex-col bg-[#fff1df]">
      <div className="container mt-24 mx-auto px-16 py-12 sm:px-8 sm:py-8">
        <h1 className="text-8xl font-bold mb-8">Featured Projects</h1>
          ...
          {["All", "UX/UI Design", "Graphic Design"].map((category) => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-lg font-medium transition-colors duration-300 ${
                selectedCategory === category ? "bg-black text-white" : "bg-gray-200 text-black hover:bg-black hover:text-white"
              }`}
            >
              {category}
            </button>
