            ...
            <div className={styles.rightColumn}>
              <div className={styles.sections}>
                ...
                <p className={`${styles.projectSummary} ${styles.textJustify}`}>
                  WeConnect is a <span className="font-bold var--secondary">one-stop instant translation</span> video conferencing web app designed to address communication challenges in Canada’s multicultural environment. It features collaborative tools, such as file sharing, virtual whiteboards, and polls, to boost productivity and fosters more efficient and inclusive collaboration.
                </p>
              </div>
              <div className={styles.sections}>
