            ...
            <div className={styles.rightColumn}>
              <div className={styles.sections}>
                ...
                <p className={`${styles.projectSummary} ${styles.textJustify}`}>
                  WeConnect is an <span className="font-bold text-primary">instant translation video conferencing</span> web app tackling communication barriers in Canada’s multicultural environment. Designed by a team of four UX/UI designers, it evolved from user research into an intuitive interface, refined through usability testing. A comprehensive style guide and asset inventory ensured a smooth developer handoff for seamless implementation.
                </p>
              </div>
              <div className={styles.sections}>
