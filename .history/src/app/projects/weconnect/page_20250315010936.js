            ...
            <div className={styles.rightColumn}>
              ...
              <div className="flex flex-row gap-5">
                ...
                <div className={styles.viewOnline}>
                  ...
                  > Try It Out <PiFigmaLogoDuotone className={styles.goArrow}/> </span>
                  </Link>
                </div>
                <div className={styles.viewOnline}>
                  <Link
        ...
        <section className={styles.sectionContainer}>
          <div>
            ...
            <div className={styles.overviewDetails}>
              <div>
                <h3 className="mb-2 text-left">Pain Point</h3>
                <p className={styles.projectSummary}>44% of respondents have faced language barriers in video conferencing apps. However, popular platforms often lock transcription features behind premium subscriptions and come with a steep learning curve.</p>
              </div>
              <div>
                <h3 className="mb-2">Solution</h3>
                <p className={styles.projectSummary}>WeConnect offers a modern, user-friendly design with instant translation and collaborative tools, boosting productivity and reducing language misunderstandings.</p>
              </div>
            </div>
          </div>
        </section>
