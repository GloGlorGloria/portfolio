...
export default function Relay() {
  ...
  const userPersona = [
    "/images/projects/weconnect/weconnect-persona1.png",
    "/images/projects/weconnect/weconnect-persona2.png",
  ];
              ...
              <div className={styles.rightColumn}>
                ...
                <div className={styles.leftColumn}>
                  <Image
                    ...
                    alt="WeConnect user persona"
                    width={800}
                    height={500}
                    className={styles.personaImage}
                    onClick={() => setSelectedImage("/images/projects/weconnect/weconnect-persona1.png")}
                    style={{ cursor: "pointer" }}
                  />
                  <Image
                    src="/images/projects/weconnect/weconnect-persona1.png"
