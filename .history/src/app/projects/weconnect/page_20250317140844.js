          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>3. Collaborative Tools <FaToolbox className={styles.designIcon__small}/></h2>
                <div className="mb-4">
                  ...
                  <br></br>
                  <ul>
                    <li className={styles.numberList}><span className="font-bold text-orange-500">Virtual Whiteboard</span> — Brainstorm visually, sketch ideas, and collaborate in real time for interactive discussions.</li>
                    <li className={styles.numberList}><span className="font-bold text-orange-500">Live Polls & Surveys</span> — Gather instant feedback, make quick decisions, and keep meetings dynamic.</li>
                    <li className={styles.numberList}><span className="font-bold text-orange-500">Screen Sharing</span> — Present ideas, walk through documents, or provide live demonstrations effortlessly.</li>
                    <li className={styles.numberList}><span className="font-bold text-orange-500">File Sharing</span> — Instantly exchange important documents, images, and resources without switching between apps.</li>
                  </ul>
                  <p className={styles.projectSummary}>
