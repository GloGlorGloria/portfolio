       ...
       {/* Overview */}
        ...
        <section className={styles.sectionContainer}>
         ...
         <section className={styles.sectionContainer}>
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            <div className={styles.leftColumn}>
            <h2 className={styles.sectionTitle}>1. Video Conferencing <FaRoute className={styles.designIcon__small}/> </h2>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
                    WeConnect's core feature is video conferencing, designed for seamless and effortless meeting creation. <span className="font-bold text-primary">Large action buttons</span> on the home page make it easy to start a meeting with a simple checkbox setup and invite participants via a shareable link. Scheduled meetings are displayed on the home screen for better planning. The interface also enables smooth screen-swiping to switch between different profile display modes. 
                  </p>
                  <br></br>
                  <p className={styles.projectSummary}> 
                    Scheduled meetings are displayed on the home screen for quick access, allowing for better planning. The interface also enables smooth screen-swiping to switch between different profile display modes.
                  </p>
                </div>        
            </div>
            {/* Left Column: Large Image */}
