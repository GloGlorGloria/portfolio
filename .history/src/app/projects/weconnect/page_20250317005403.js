         ...
         <section className={styles.sectionContainer}>
          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            <h2 className={styles.sectionTitle}>1. Video Conferencing <FaRoute className={styles.designIcon__small}/> </h2>
                <div className="mb-4">
                  <p className={styles.projectSummary}>
                    WeConnect's core feature is video conferencing, designed for seamless and effortless meeting creation to connect the world. <span className="font-bold text-primary">Large action buttons</span> on the home page make it easy to start a meeting with a simple checkbox setup and invite participants via a shareable link. 
                  </p>
                  <br></br>
                  <p className={styles.projectSummary}> 
