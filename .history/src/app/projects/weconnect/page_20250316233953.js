            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div className={`${styles.viewOnline} ${styles.viewOnline__container}`} >
                  <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://embed.figma.com/design/TiCeTfzkb5qknBkhFhYRGB/WeConnect-%E2%80%94-Instant-Translation-Video-Conferencing?node-id=50760-47724&embed-host=share" allowfullscreen></iframe>
                  <Link
                  ...
                  <span 
                    className="bg-[#fff0df] hover:text-orange-500 rounded-full px-3.5 py-1.5" 
                  > Explore Details <FaCirclePlay className={styles.goArrow}/> </span>
