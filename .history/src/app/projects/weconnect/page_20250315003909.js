            ...
            <div className={styles.rightColumn}>
              <div className={styles.sections}>
                ...
                <p className={`${styles.projectSummary} ${styles.textJustify}`}>
                  WeConnect is an <span className="font-bold text-primary">instant translation video conferencing web app</span> designed to break language barriers in Canada’s multicultural communities. Created by a team of 4 UX/UI designers, the project focused on user research, usability testing, and intuitive design to ensure a seamless experience. A detailed style guide and asset inventory helped full-stack developers bring the design to life.
                </p>
              </div>
              <div className={styles.sections}>
