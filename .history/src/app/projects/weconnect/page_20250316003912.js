          ...
          <div className={`${styles.projectDetails} ${styles.casestudy__section}`}>
            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div>
                  <ul>
                    <li className={styles.numberList}><span className="font-bold text-secondary">Speech-to-Text Over Live Translation</span> — Preferred to reduce chaos and improve meeting follow-ups.</li>
                    <li className={styles.numberList}><span className="font-bold text-secondary">Integrated Collaboration Tools</span> — High demand for whiteboards, documents sharing, and polling to enhance collaboration.</li>
                    <li className={styles.numberList}><span className="font-bold text-secondary">Privacy Concerns</span> — Respondents emphasize data security and the need for protected information storage.</li>
                  </ul>
                </div>
                <div>
                  <p className={styles.projectSummary}>
