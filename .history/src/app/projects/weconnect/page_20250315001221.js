          ...
          <div className={styles.projectDetails}>
            ...
            <div className={styles.rightColumn}>
              <div className={styles.sections}>
                ...
                WeConnect is a one-stop instant translation video conferencing web app designed to address communication challenges in Canada’s multicultural environment, featuring collaborative tools to enhance productivity.
                </p>
              </div>
              <div className={styles.sections}>
