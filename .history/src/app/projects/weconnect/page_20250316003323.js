            ...
            {/* Left Column: Large Image */}
              ...
              <div className={styles.sections}>
                ...
                <div className="mb-4">
                  ...
                  A survey of <span className="font-bold text-primary">31 respondents</span> was conducted to analyze video conferencing usage, transcription needs, and preferences for an all-in-one platform. 80% of respondents use Zoom, making it a key reference for secondary research. To gain deeper insights, online reviews and user experience analyses were conducted, identifying both strengths and weaknesses. These findings serve as valuable references in designing the collaborative app.
                  </p>
                </div>
                <div>
                  <ul>
