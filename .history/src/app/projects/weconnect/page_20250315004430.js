            ...
            <div className={styles.rightColumn}>
              <div className={styles.sections}>
                ...
                <p className={`${styles.projectSummary} ${styles.textJustify}`}>
                  WeConnect is a <span className="font-bold text-primary">one-stop instant translation video conferencing</span> web app designed to overcome communication challenges in Canada’s multicultural environment. Created by a team of four UX/UI designers, the project began with user research, evolved into intuitive design, and was refined through usability testing to ensure a seamless experience.A detailed style guide and asset inventory ensured a seamless handoff to full-stack developers, bringing the design to life efficiently.
                </p>
              </div>
              <div className={styles.sections}>
