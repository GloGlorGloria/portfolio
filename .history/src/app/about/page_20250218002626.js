    ...
    //   <div className="container mt-24 mx-auto px-10 py-12">
      ...
      <div className={styles.contentContainer}>
        ...
        <section className={styles.sectionContainer}>
          ...
          <Swiper spaceBetween={20} slidesPerView={3} loop autoplay={{ delay: 2000 }}>
            {["teaset.JPG", "brewtea.png", "teaset2.png", "banff.jpg", "seattle.JPG", "snow.jpg"].map((img, index) => (
              <SwiperSlide key={index}>
                <Image src={`/images/${img}`} alt="Tea" width={380} height={250} />
              </SwiperSlide>
            ))}
          </Swiper>
            {/* <Image    
