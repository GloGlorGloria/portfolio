      ...
      <div className={styles.contentContainer}>
        ...
        <section className={styles.sectionContainer}>
          <div className={styles.profileMore}>
            <h1>What's More?</h1>
            <p className={styles.projectSummary}>In my leisure time, I enjoy brewing Chinese tea to unwind and refresh my mind, as well as discovering new places with my family and friends!</p>
